...
# This script implements a DOE experiment over a subject list. 
# This version computes fat and water ratio images before segmentation.
# Main steps:
...
if ( scalar(@ARGV) < 3 ) {
  print "Usage: ThymusDixonQuantificationDOE.pl <DOE file> <SubjectFile> <Input Data Path> <Extra Arguments>\n";
  print "Thymus quantification DOE script that computes fat ratio and water ratio images before segmentation.\n";
  exit;
}
...
$thymusQuantifier = "ThymusDixonQuantificationCL.pl";
